...
<div class="col-sm-12">
    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <img src="{{url('images/frontend_img/banners/cover.jpg')}}" alt="">
            </div>
            <div class="item">
            <img src="{{url('images/frontend_img/banners/cover2.jpg')}}" alt="">
            </div>
            
            <div class="item">
            <img src="{{url('images/frontend_img/banners/cover3.jpg')}}" alt="">
            </div>
