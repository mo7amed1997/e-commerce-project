...
<div class="contactinfo">
    <ul class="nav nav-pills">
        <li><a href="#"><i class="fa fa-phone"></i> +2011236745</a></li>
        <li><a href="#"><i class="fa fa-envelope"></i> teamit333@gmail.com</a></li>
    </ul>
</div>
</div>
<div class="col-sm-6">
            ...
            <div class="col-sm-4">
                <div class="logo pull-left">
                    <a href="{{url('http://hyper-mart.me')}}">
                        <img src="{{url('/images/frontend_img/home/logo333.png')}}" alt="" style="width: 70px;height: 70px;">
<span style="font-size:30px; ">E_shopper</span>
                    </a>
